...
set(_DEP_TAG 0a92994d729ff76a58f692d3028ca1b64b145d91)
...
if(NOT EXISTS ${_DEP_PREFIX}/include/fp16.h)
    ...
    if(NOT EXISTS ${_DEP_PREFIX}/include/fp16.h)
        ...
        file(COPY ${CMAKE_CURRENT_LIST_DIR}/src/include DESTINATION ${_DEP_PREFIX})
...
if(NOT TARGET ${_DEP_LNAME} AND EXISTS ${_DEP_PREFIX}/include/fp16.h)

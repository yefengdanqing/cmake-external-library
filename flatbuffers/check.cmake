...
if(NOT EXISTS ${_DEP_PREFIX}/include/${_DEP_NAME}/${_DEP_NAME}.h)
...
if(NOT TARGET ${_DEP_NAME}::flatc AND EXISTS ${_DEP_BIN_DIR}/flatc)
    add_executable(${_DEP_NAME}::flatc IMPORTED)
    set_target_properties(${_DEP_NAME}::flatc PROPERTIES
        IMPORTED_LOCATION "${_DEP_BIN_DIR}/flatc")
endif()

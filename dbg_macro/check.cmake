...
#2021-08-08
set(_DEP_TAG 4409d8428baf700873bcfee42e63bbca6700b97e)
set(_DEP_TAG c7424695eff81dd34c7a0614160492ce1b4f0c08)
set(_DEP_URL https://github.com/sharkdp/${_DEP_LNAME}.git)
...
if(NOT EXISTS ${_DEP_PREFIX}/include/dbg.h)
    ...
    if(NOT EXISTS ${_DEP_PREFIX}/include/dbg.h)
        ...
        file(COPY ${CMAKE_CURRENT_LIST_DIR}/src/dbg.h DESTINATION ${_DEP_PREFIX}/include)
...
if(NOT TARGET ${_DEP_LNAME} AND EXISTS ${_DEP_PREFIX}/include/dbg.h)

...
set(_DEP_VER 0.6.2)
set(_DEP_URL https://github.com/jbeder/${_DEP_NAME}/archive/${_DEP_NAME}-${_DEP_VER}.tar.gz)
if(OFF)
    SetDependPrefix()
    CheckVersion()
    FetchAndInstall(
        ...
        PREFIX ${_DEP_PREFIX}
        UNAME ${_DEP_UNAME}
        BUILD_GUARD ${_DEP_PREFIX}/include/${_DEP_NAME}/yaml.h
        COMMAND
...
if(NOT EXISTS ${_DEP_PREFIX}/include/${_DEP_NAME}/yaml.h)

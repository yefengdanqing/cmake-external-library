...
set(_DEP_VER v1.6.0)
set(_DEP_URL https://github.com/google/benchmark/archive/refs/tags/${_DEP_VER}.tar.gz)
...
if(NOT EXISTS ${_DEP_PREFIX}/include/${_DEP_NAME}/${_DEP_NAME}.h)
    ...
    if(NOT EXISTS ${CMAKE_CURRENT_LIST_DIR}/build/googlemock/${_DEP_NAME}/lib${_DEP_NAME}.a)

...
set(_DEP_URL https://github.com/datastax/cpp-driver/archive/${_DEP_VER}.tar.gz)
...
if(NOT EXISTS ${_DEP_PREFIX}/include/cassandra.h)
    ...
    if(NOT EXISTS ${CMAKE_CURRENT_LIST_DIR}/build/libcassandra_static.a)
...
#pkg_search_module(CASSANDRA_CPP_DRIVER REQUIRED cassandra_static)
if(NOT TARGET ${_DEP_NAME}::${_DEP_NAME} AND EXISTS ${_DEP_LIB_DIR}/libcassandra_static.a)
    add_library(${_DEP_NAME}::${_DEP_NAME} STATIC IMPORTED)
    set_target_properties(${_DEP_NAME}::${_DEP_NAME} PROPERTIES
        IMPORTED_LOCATION "${_DEP_LIB_DIR}/libcassandra_static.a"

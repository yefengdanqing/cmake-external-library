include(${CMAKE_CURRENT_LIST_DIR}/../xtl/check.cmake OPTIONAL)
if("${XTL_PREFIX}" STREQUAL "")
    get_filename_component(_DEP_NAME ${CMAKE_CURRENT_LIST_DIR} NAME)
    message(FATAL_ERROR "${_DEP_NAME} requires xtl")
endif()
if(NOT TARGET xtl)
    get_filename_component(_DEP_NAME ${CMAKE_CURRENT_LIST_DIR} NAME)
    message(FATAL_ERROR "${_DEP_NAME} requires xtl")
...
include(${CMAKE_CURRENT_LIST_DIR}/../xsimd/check.cmake OPTIONAL)
if("${XSIMD_PREFIX}" STREQUAL "")
    get_filename_component(_DEP_NAME ${CMAKE_CURRENT_LIST_DIR} NAME)
    message(FATAL_ERROR "${_DEP_NAME} requires xsimd")
endif()
if(NOT TARGET xsimd)
    get_filename_component(_DEP_NAME ${CMAKE_CURRENT_LIST_DIR} NAME)
    message(FATAL_ERROR "${_DEP_NAME} requires xsimd")
...
set(_DEP_VER 0.20.8)
set(_DEP_URL https://github.com/QuantStack/${_DEP_NAME}/archive/${_DEP_VER}.tar.gz)
...
if(NOT EXISTS ${_DEP_PREFIX}/lib64/cmake/${_DEP_NAME}/${_DEP_NAME}Config.cmake)
    ...
    if(NOT EXISTS ${CMAKE_CURRENT_LIST_DIR}/build/CMakeCache.txt)
        ...
        execute_process(
            COMMAND ${CMAKE_COMMAND}
                    ...
                    -Dxtl_DIR=${XTL_LIB_DIR}/cmake/xtl
                    -Dxsimd_DIR=${XSIMD_LIB_DIR}/cmake/xsimd
    ...
    if(NOT EXISTS ${CMAKE_CURRENT_LIST_DIR}/build/${_DEP_NAME}Config.cmake)

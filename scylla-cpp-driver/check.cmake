...
set(_DEP_VER 2.16.1-1)
set(_DEP_URL https://github.com/scylladb/cpp-driver/archive/refs/tags/${_DEP_VER}.tar.gz)
...
if(NOT EXISTS ${_DEP_PREFIX}/include/cassandra.h)
    ...
    if(NOT EXISTS ${CMAKE_CURRENT_LIST_DIR}/build/libscylla-cpp-driver_static.a)
...
message("XXXXXXXXXXXXXXXXXXXXXX $ENV{PKG_CONFIG_PATH}")
#pkg_search_module(SCYLLA_CPP_DRIVER REQUIRED scylla-cpp-driver_static)
if(NOT TARGET ${_DEP_NAME}::${_DEP_NAME} AND EXISTS ${_DEP_LIB_DIR}/libscylla-cpp-driver_static.a)
    add_library(${_DEP_NAME}::${_DEP_NAME} STATIC IMPORTED)
    set_target_properties(${_DEP_NAME}::${_DEP_NAME} PROPERTIES
        IMPORTED_LOCATION "${_DEP_LIB_DIR}/libscylla-cpp-driver_static.a"
        INTERFACE_INCLUDE_DIRECTORIES "${_DEP_INCLUDE_DIR}"
        IMPORTED_LINK_INTERFACE_LIBRARIES libuv::libuv)
endif()

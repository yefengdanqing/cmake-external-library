...
set(_DEP_VER 2.2.1)
set(_DEP_URL https://github.com/${_DEP_NAME}/${_DEP_NAME}/archive/v${_DEP_VER}.tar.gz)
...
if(NOT EXISTS ${_DEP_PREFIX}/lib/lib${_DEP_NAME}.a)
    ...
    if(NOT EXISTS ${CMAKE_CURRENT_LIST_DIR}/build/lib/lib${_DEP_NAME}.a)
...
if(NOT TARGET ${_DEP_NAME}::${_DEP_NAME}_nothreads AND EXISTS ${_DEP_LIB_DIR}/lib${_DEP_NAME}_nothreads.a)
    add_library(${_DEP_NAME}::${_DEP_NAME}_nothreads STATIC IMPORTED)
    set_target_properties(${_DEP_NAME}::${_DEP_NAME}_nothreads PROPERTIES
        IMPORTED_LOCATION "${_DEP_LIB_DIR}/lib${_DEP_NAME}_nothreads.a"
        INTERFACE_INCLUDE_DIRECTORIES "${_DEP_INCLUDE_DIR}")
endif()

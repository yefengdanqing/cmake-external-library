include(${CMAKE_CURRENT_LIST_DIR}/../fmt/check.cmake OPTIONAL)
if("${FMT_PREFIX}" STREQUAL "")
    get_filename_component(_DEP_NAME ${CMAKE_CURRENT_LIST_DIR} NAME)
    message(FATAL_ERROR "${_DEP_NAME} requires fmt")
endif()
if(NOT TARGET fmt::fmt)
    get_filename_component(_DEP_NAME ${CMAKE_CURRENT_LIST_DIR} NAME)
    message(FATAL_ERROR "${_DEP_NAME} requires fmt::fmt")
endif()

get_filename_component(_DEP_NAME ${CMAKE_CURRENT_LIST_DIR} NAME)
string(TOUPPER ${_DEP_NAME} _DEP_UNAME)

set(_DEP_TAG 3adfeeec3ed0131c3f07bfc7bb1f4003bb2eb981)
set(_DEP_URL https://github.com/gabime/${_DEP_NAME}.git)
...
if(NOT EXISTS ${_DEP_PREFIX}/lib/spdlog/libspdlog.a)
    ...
    if(NOT EXISTS ${_DEP_PREFIX}/include/${_DEP_NAME}/spdlog.h)

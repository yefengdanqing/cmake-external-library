...
if(NOT TARGET openssl::crypto)
    get_filename_component(_DEP_NAME ${CMAKE_CURRENT_LIST_DIR} NAME)
    message(FATAL_ERROR "${_DEP_NAME} requires openssl::crypto")
endif()
...
set(_DEP_VER 7.83.1)
set(_DEP_URL https://${_DEP_NAME}.haxx.se/download/${_DEP_NAME}-${_DEP_VER}.tar.gz)
...
if(NOT EXISTS ${_DEP_PREFIX}/lib/lib${_DEP_NAME}.a)
    ...
    if(NOT EXISTS ${CMAKE_CURRENT_LIST_DIR}/src/.lib/lib${_DEP_NAME}.a)
...
if(NOT TARGET ${_DEP_NAME}::lib${_DEP_NAME} AND EXISTS ${_DEP_LIB_DIR}/lib${_DEP_NAME}.a)
    ...
    set_target_properties(${_DEP_NAME}::lib${_DEP_NAME} PROPERTIES
        ...
        INTERFACE_LINK_LIBRARYES "openssl::ssl;z;dl;openssl::crypto"

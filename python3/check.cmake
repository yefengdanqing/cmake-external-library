...
set(_DEP_VER_MAJOR 3)
set(_DEP_VER_MINOR 7)
set(_DEP_VER_PATCH 3)
...
if(EXISTS ${_DEP_INCLUDE_DIR}/python${_DEP_VER}m)
    set(_DEP_INCLUDE_PATH ${_DEP_INCLUDE_DIR}/python${_DEP_VER}m)
...
if(NOT TARGET ${_DEP_NAME}::libpython AND EXISTS ${_DEP_LIB_DIR}/libpython${_DEP_VER}m.so)
    add_library(${_DEP_NAME}::libpython SHARED IMPORTED)
    set_target_properties(${_DEP_NAME}::libpython PROPERTIES
        IMPORTED_LOCATION "${_DEP_LIB_DIR}/libpython${_DEP_VER}m.so"
        INTERFACE_LINK_LIBRARIES "pthread"
        INTERFACE_INCLUDE_DIRECTORIES "${_DEP_INCLUDE_PATH}"
        INTERFACE_COMPILE_OPTIONS "-pthread")
endif()
if(NOT TARGET ${_DEP_NAME}::libpython_abi AND EXISTS ${_DEP_LIB_DIR}/libpython3.so)
    add_library(${_DEP_NAME}::libpython_abi SHARED IMPORTED)
    set_target_properties(${_DEP_NAME}::libpython_abi PROPERTIES
        IMPORTED_LOCATION "${_DEP_LIB_DIR}/libpython3.so"
        INTERFACE_LINK_LIBRARIES "pthread"
        INTERFACE_INCLUDE_DIRECTORIES "${_DEP_INCLUDE_PATH}"
        INTERFACE_COMPILE_DEFINITIONS "Py_LIMITED_API"
        INTERFACE_COMPILE_OPTIONS "-pthread")
endif()

...
set(_DEP_VER 4.3.2)
set(_DEP_URL https://github.com/${_DEP_NAME}/libzmq/releases/download/v${_DEP_VER}/${_DEP_NAME}-${_DEP_VER}.tar.gz)
...
if(NOT EXISTS ${_DEP_PREFIX}/share/cmake/ZeroMQ/ZeroMQConfig.cmake)
    ...
    if(NOT EXISTS ${CMAKE_CURRENT_LIST_DIR}/build/ZeroMQConfig.cmake)

include(${CMAKE_CURRENT_LIST_DIR}/../mkl/check.cmake)
get_filename_component(_DEP_NAME ${CMAKE_CURRENT_LIST_DIR} NAME)
string(TOUPPER ${_DEP_NAME} _DEP_UNAME)

set(_DEP_VER 1.7.0)
set(_DEP_URL https://github.com/facebookresearch/${_DEP_NAME}/archive/refs/tags/v${_DEP_VER}.tar.gz)
...
if(NOT EXISTS ${_DEP_PREFIX}/lib64/lib${_DEP_NAME}.a)
    ...
    if(NOT EXISTS ${CMAKE_CURRENT_LIST_DIR}/build/CMakeCache.txt)
        ...
        #message("install dir  = ${_DEP_PREFIX}")
        ...
        execute_process(
            COMMAND ${CMAKE_COMMAND}
                    ...
                    -DBUILD_TESTING=OFF
                    -DFAISS_ENABLE_GPU=${USE_TORCH_CUDA}
                    -DCMAKE_C_COMPILER=${CMAKE_C_COMPILER}
                    -DCMAKE_CXX_COMPILER=${CMAKE_CXX_COMPILER}
                    -DBLA_VENDOR=Intel10_64_dyn
                    -DCMAKE_CUDA_ARCHITECTURES=70 75 80
                    #-DMKL_LIBRARIES=${MKLROOT_PATH}/lib/libmkl_intel_lp64.so

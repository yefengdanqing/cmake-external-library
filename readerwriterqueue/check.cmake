...
set(_DEP_TAG 2ae710de996a1d02bbc7696b2cdff2c6078e76f8)
set(_DEP_URL https://github.com/cameron314/readerwriterqueue)
...
CheckVersion()
if(NOT EXISTS ${_DEP_PREFIX}/include/readerwriterqueue/readerwriterqueue.h)
    if(NOT EXISTS ${CMAKE_CURRENT_LIST_DIR}/src/readerwriterqueue.h)
    ...
    if(NOT EXISTS ${_DEP_PREFIX}/include/readerwriterqueue/readerwriterqueue.h)
        ...
        execute_process(
            COMMAND mkdir -p ${_DEP_PREFIX}/include/readerwriterqueue/
            WORKING_DIRECTORY ${CMAKE_CURRENT_LIST_DIR}/src
            RESULT_VARIABLE rc)
        if(NOT "${rc}" STREQUAL "0")
        ...
        execute_process(
            COMMAND cp -r readerwriterqueue.h atomicops.h ${_DEP_PREFIX}/include/readerwriterqueue/
            WORKING_DIRECTORY ${CMAKE_CURRENT_LIST_DIR}/src/
            RESULT_VARIABLE rc)
        if(NOT "${rc}" STREQUAL "0")
